...
class HomeController extends PublicController
{
  ...
  {
		if (!$records = getCachedRecords('public-page-home')) {
			...
			$records = cacheRecords('public-page-home', [
				'landingZoneBanners' => $landingZoneBanners,
				'categories' => $categories
			]);
		}

		$landingZoneBanners = $records['landingZoneBanners'];
