<template>
  ...
  <button class="page-button" type="button" :class="{ 'button-active' : showCreate == true }"
  @click="showCreate = !showCreate">Add User</button>

  <form class="web-box" v-show="showCreate" action="/usersCreate" method="POST" enctype="multipart/form-data">
    <i class="fa-solid fa-xmark" @click="showCreate = false"></i>
